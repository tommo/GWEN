...
MOAIGwenControl* MOAIGwenControl::_GwenToMoai( Gwen::Controls::Base* control0 ) {
	...
	TRY_GWEN_TO_MOAI( Properties,             Properties,           control0 )
	TRY_GWEN_TO_MOAI( PropertyRow,            PropertyRow,          control0 )
	TRY_GWEN_TO_MOAI( PropertyTree,           PropertyTree,         control0 )
	TRY_GWEN_TO_MOAI( Property::Base,         BaseProperty,         control0 )
	...
	TRY_GWEN_TO_MOAI( TabControl,             TabControl,           control0 )
	TRY_GWEN_TO_MOAI( TabButton,              TabButton,            control0 )
	...
	TRY_GWEN_TO_MOAI( PageControl,            PageControl,          control0 ) 
